    ...
    <div class="row">
        ...
        <div class="col-md-10">                                            
            <div class="card" style="padding: 2rem;" >
                   ...
                   <div class="row">
                    <div class="col-md-12">
                                   ...
                                   <div class="form-group row">
                                    ...
                                    <div class="col-sm-8 ">
                                       <div class="input-group mb-3">
                                        <input disabled type="text" class="form-control" id="id1" placeholder="Enter CaseID" >
                                    </div> 
                                ...
                                <div class="col-sm-8 ">
                                   <div class="input-group mb-3">
                                    <div class="custom-checkbox">
                                        <input type="checkbox" class="form-check-input" value="yes" id="emailc"> 
                                    </div>
                                    <input disabled type="text" class="form-control" id="email" placeholder="Enter Email" >
                                </div> 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 ">
                               <div class="input-group mb-3">
                                <div class="custom-checkbox">
                                    <input type="checkbox" class="form-check-input" value="yes" id="fullnamec"> 
                                </div>
                                <input disabled type="text" class="form-control" id="fullname" placeholder="Enter Full Name">
                            </div> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8 ">
                           <div class="input-group mb-3">
                            <div class="custom-checkbox">
                                <input type="checkbox" class="form-check-input" value="yes" id="fathersnamec"> 
                            </div>
                            <input disabled type="text" class="form-control" id="fathersname" placeholder="Enter Father's Name">
                        </div> 
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 ">
                       <div class="input-group mb-3">
                          <div class="custom-checkbox">
                            <input type="checkbox" class="form-check-input" value="yes" id="contactc"> 
                        </div>
                        <input disabled type="text" class="form-control numbersOnly" minlength="11"  maxlength="11" id="contact" placeholder="Enter Contact">
                    </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8 "> 
                  <div class="custom-checkbox">
                    <input type="checkbox" class="form-check-input" value="yes" id="cityc"> 
                </div>
                <select class="select2 form-control mb-3 custom-select " style="width: 100%; height:36px;" tabindex="-1" aria-hidden="true" disabled id="city" >
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8 ">
               <div class="input-group mb-3">
                   <div class="custom-checkbox">
                    <input type="checkbox" class="form-check-input" value="yes" id="NetSalaryc"> 
                </div>
                <input disabled type="text" class="form-control numbersOnly" id="NetSalary" placeholder="Enter Net Salary" >
            </div> 
...
<div class="col-md-6">
   <div class="form-group row">
    ...
    <div class="col-sm-8 ">
       <div class="input-group mb-3">
           <div class="custom-checkbox">
            <input type="checkbox" class="form-check-input" value="yes" id="cnicc"> 
        </div>
        <input disabled type="text" class="form-control numbersOnly" maxlength="13" id="cnic" placeholder="Enter Cnic">
    </div> 
...
<div class="form-group row">
    ...
    <div class="col-sm-8 ">
       <div class="input-group mb-3">
        <div class="custom-checkbox">
            <input type="checkbox" class="form-check-input" value="yes" id="Addressc"> 
        </div>
        <input disabled type="text" class="form-control" id="Address" placeholder="Enter Address">
    </div> 
...
<div class="form-group row">
    ...
    <div class="col-sm-8 "> 
      <div class="custom-checkbox">
        <input type="checkbox" class="form-check-input" value="yes" id="casetypec"> 
    </div>
    <select class="select2 form-control mb-3 custom-select " style="width: 100%; height:36px;" tabindex="-1" aria-hidden="true" id="casetype" disabled onchange="business_change();">
...
<div id="div_businesstype" style="">
  <div class="form-group row">
    ...
    <div class="col-sm-8 "> 
      <div class="custom-checkbox">
        <input type="checkbox" class="form-check-input" value="yes" id="natureofbusinessc"> 
    </div>
    <select class="select2 form-control mb-3 custom-select " style="width: 100%; height:36px;" tabindex="-1" aria-hidden="true" id="natureofbusiness" disabled onchange="business_change2();">
...
<div id="div_othernature" style="">
    <div class="form-group row">
        ...
        <div class="col-sm-8 ">
           <div class="input-group mb-3">
              <div class="custom-checkbox">
                <input type="checkbox" class="form-check-input" value="yes" id="otherbusinessc"> 
            </div>
            <textarea disabled class="form-control" id="otherbusiness" placeholder="Enter Other Business Description"></textarea> >
        </div>
...
<div class="form-group row">
    ...
    <div class="col-sm-8 ">
       <div class="input-group mb-3">
          <div class="custom-checkbox">
            <input type="checkbox" class="form-check-input" value="yes" id="casedescc"> 
        </div>
        <textarea disabled class="form-control" id="casedesc" placeholder="Enter Case Description"></textarea> >
    </div>
